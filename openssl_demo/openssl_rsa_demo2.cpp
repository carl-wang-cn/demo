...
char *my_decrypt(char *str, char *path_key)
{
    ...
    int de_len = RSA_private_decrypt(flen, (unsigned char *)str, (unsigned char*)p_de, p_rsa, RSA_PKCS1_PADDING);
    if (de_len < 0)
    {
